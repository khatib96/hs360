...
typedef ContractRowTap = void Function(ContractSummary summary);

class ContractCompactTable extends StatelessWidget {
  const ContractCompactTable({
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: ConstrainedBox(
        ...
        child: DataTable(
          key: const Key('contract-compact-table'),
          ...
          rows: [
            for (final contract in contracts)
              DataRow(
                onSelectChanged: (_) => onRowTap(contract),
                cells: [
