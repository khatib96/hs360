...
import 'customer_vouchers_state.dart';

part 'customer_vouchers_controller.g.dart';

@riverpod
class CustomerVouchersController extends _$CustomerVouchersController {
