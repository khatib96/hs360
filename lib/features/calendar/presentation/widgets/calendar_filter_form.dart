...
/// Shared filter facet editor used by desktop popover and mobile bottom sheet.
class CalendarFilterForm extends StatefulWidget {
  const CalendarFilterForm({
  ...
  @override
  State<CalendarFilterForm> createState() => _CalendarFilterFormState();
}

class _CalendarFilterFormState extends State<CalendarFilterForm> {
