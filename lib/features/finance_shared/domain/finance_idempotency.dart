...
class FinanceIdempotencySession {
  FinanceIdempotencySession() : _key = _newUuidV4();
  ...
  bool shouldPreserveKeyOn(FinanceException error) {
    return switch (error.code) {
      ...
      FinanceException.notAvailable => false,
      _ => true,
    };
  }
}
